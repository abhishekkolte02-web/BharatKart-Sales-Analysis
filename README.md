# BharatKart-Sales-Analysis
End-to-end data analytics project using Python, SQL and Power Bi dashboard.
**BharatKart Sales & Business Performance Dashboard**
**Project Overview :**
This project demonstrates an end-to-end data analytics workflow, starting from raw data cleaning to dashboard visualization.
The dataset was cleaned using Python, analyzed using SQL, and visualized using Power BI to generate business insights.
...
**Tools & Technologies:**
  ...
  - Excel / CSV
****Workflow**:**
  - Raw dataset collected in CSV format
